...
public class DataLoader {
    ...
    public void LoadData() {
        if(bikenestRepository.count() == 0){
            Bikenest bikenest_hbf_1 = new Bikenest();
            bikenest_hbf_1.setName("Nürnberg Hbf Süd 1");
            bikenest_hbf_1.setGPSCoordinates("49.444081807031665, 11.082422685617997");
            bikenest_hbf_1.setSpotsLeft(13);
            bikenestRepository.save(bikenest_hbf_1);

            Bikenest bikenest_hbf_2 = new Bikenest();
            bikenest_hbf_2.setName("Nürnberg Hbf Süd 2");
            bikenest_hbf_2.setGPSCoordinates("49.44408428763211, 11.0826287061008");
            bikenest_hbf_2.setSpotsLeft(8);
            bikenestRepository.save(bikenest_hbf_2);

            Bikenest bikenest_hbf_3 = new Bikenest();
            bikenest_hbf_3.setName("Nürnberg Hbf Nord 1");
            bikenest_hbf_3.setGPSCoordinates("49.446344470022375, 11.0810884309534938");
            bikenest_hbf_3.setSpotsLeft(13);
